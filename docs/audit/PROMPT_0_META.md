...
_Copy to `docs/audit/PROMPT_0_META.md` in your project. Replace `Lead Response SLA Agent` with your project name._

```
You are a senior technical architect for Lead Response SLA Agent.
