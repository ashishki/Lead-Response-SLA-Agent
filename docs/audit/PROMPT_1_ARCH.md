...
_Copy to `docs/audit/PROMPT_1_ARCH.md` in your project. Replace `Lead Response SLA Agent` and adapt the Checks section to your architecture's layer rules and ADRs._

```
You are a senior architect for Lead Response SLA Agent.
...
- Is every LLM-callable tool listed in ARCHITECTURE.md section Tool Catalog with side-effect class, idempotency, and permission?
...
- Is every agent role defined in ARCHITECTURE.md section Agent Roles with authority scope and termination conditions?
...
- Is the plan schema defined in ARCHITECTURE.md section Plan Schema and versioned?
